...
**Tech Stack:** Go 1.25, standard library HTTP/process/terminal primitives, Bubble Tea v2.0.3, existing Ollama/OpenAI/config/credential/provider packages, Claude Code JSON output, React/Vitest only for the browser activation handoff.
...
- [x] **Step 4: Add OpenAI model-catalog tests and implementation**
...
- [x] **Step 3: Implement stable selection and rollback**
...
- [x] **Step 4: Route legacy Ollama host setup through the service**
...
- [x] **Step 3: Implement minimal native execution**
...
- [x] **Step 4: Register image-less Claude**
...
- [x] **Step 1: Add Bubble Tea v2**

Run: `go get charm.land/bubbletea/v2@v2.0.3 charm.land/bubbles/v2@v2.0.0`

Expected: modules are added and the module language version is raised to Go 1.25, the minimum required by Bubble Tea v2.0.3.
...
- [x] **Step 4: Implement the reducer and views**
...
- [x] **Step 5: Implement asynchronous commands**
...
- [x] **Step 4: Document both interaction styles**
...
- [x] **Step 1: Write failing activation API tests**
...
- [x] **Step 3: Implement the bounded in-memory draft store and endpoints**
...
- [x] **Step 4: Implement browser completion**
...
- [x] **Step 5: Resume the TUI after confirmation**
