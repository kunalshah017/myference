...
import { formatMON, isFreshReferencePrice, weiToUSD } from '../lib/amount'
...
export function Money({ wei, technical = false }: { wei: bigint | string; technical?: boolean }) {
  ...
  return <span className="money-value">
    ...
    {isFreshReferencePrice(quote.data) && <small>≈ {weiToUSD(wei, quote.data!.usd_per_mon)} · reference</small>}
