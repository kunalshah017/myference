...
export function DashboardOverview({ api = new OperationsAPI(), onNavigate }: { api?: OperationsAPI; onNavigate?: (view: 'models' | 'playground' | 'api' | 'hosting') => void }) {
  ...
  return <section>
    ...
    <div className="availability-note"><ShieldAlert size={18} aria-hidden="true" /><p><strong>Slashing visibility</strong><br />Historical slashing data is not exposed by the account indexer yet. Current bonded collateral and bond-exit state remain live.</p></div>
  </section>
}
