  ...
  return <div className="dashboard-shell">
    ...
    <div className="dashboard-main">
      ...
      <main className="dashboard-workspace">
        ...
        {view === 'earnings' && <section><p className="eyebrow">Provider settlement</p><h1>Earnings and stake</h1>{session ? <ProviderAnalytics /> : disconnected('Connect a wallet to inspect earnings, settlement, and slashing history.')}</section>}
      </main>
    </div>
  </div>
}
