...
ollama list`}</CopyBlock></Step>
			...
			<Step number="05" title="Stake and publish"><p>Stay in the terminal UI to choose Collateral or Offers &amp; Pricing. Enter MON values there; Myference opens only a minimal short-lived wallet page showing the exact action. The CLI resumes after finalized indexed chain state proves the action. Your wallet key never enters the CLI.</p></Step>
