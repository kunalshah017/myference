...
ollama list`}</CopyBlock></Step>
            ...
            <Step number="05" title="Stake and publish"><p>Myference opens a short-lived Host inference tab for the providers selected in the terminal. Deposit at least the displayed minimum collateral, then enter input and output prices per 1M tokens and a compute price per minute. With a fresh quote these fields use USD and preview the exact MON rates that will be locked on-chain; without one they use MON. Confirm the wallet transactions; when every offer is published, the terminal continues automatically.</p></Step>
