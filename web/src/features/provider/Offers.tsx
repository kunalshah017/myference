...
export function Offers({ offers, publish, disabled = false, pendingLabel }: { offers: EditableProviderOffer[]; publish: (input: ProviderActionInput) => Promise<void>; disabled?: boolean; pendingLabel?: string }) {
